...
do
    print("Testing...", "thread 18: cancel - par_or cancels sleeping thread")
    spawn(function ()
        local cleaned = false
        local v = par_or(
            function ()
...
do
    print("Testing...", "thread 19: cancel - watching cancels sleeping thread")
    spawn(function ()
        local cleaned = false
...
do
    print("Testing...", "thread 20: cancel - parent death cancels thread")
    local cleaned = false
    spawn(function ()
        spawn(function ()
            local _ <close> = defer(function ()
...
do
    print("Testing...", "thread 21: cancel - defer fires inside lane body")
    spawn(function ()
        local v = thread(function ()
            local log = { "start" }
            do
...
--[[
do
    print("Testing...", "thread 22: cancel - defer fires inside lane body on cancel")
